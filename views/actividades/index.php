                        ...
                        <td>
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                    <li><a class="dropdown-item" href='?controller=actividades&action=show&id=<?php echo $actividad->id; ?>'>Ver</a></li>
                                    <li><a class="dropdown-item" href='?controller=actividades&action=edit&id=<?php echo $actividad->id; ?>'>Editar</a></li>
                                    <li><a class="dropdown-item" href='?controller=actividades&action=asistencia&id=<?php echo $actividad->id; ?>'>Asistencia</a></li>
